...
import { Nav, Dropdown, DropdownItem, DropdownToggle, UncontrolledDropdown, DropdownMenu, InputGroup, InputGroupAddon, InputGroupText, Input } from 'reactstrap';
                            ...
                            <InputGroup>
                                <InputGroupAddon addonType="prepend">
                                    <InputGroupText className='search-button'>
                                        <svg class="o-icon u-padding--10" viewBox="0 0 50 50" aria-label="Search icon" role="img">
                        ...
                        <Dropdown nav isOpen={this.state.dropdownUserOpen} toggle={this.toggleUser}>
                            <UncontrolledDropdown nav inNavbar>
                                <DropdownToggle nav caret className='dropdownToggle'>
                                    <img src={avt} alt={avt} />
                                    <span>{AuthService.userInfo.first_name}</span>
                                </DropdownToggle>
                                <DropdownMenu right>
